    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!ob.dr.Read())
            {
                ...
                string str = "insert into uregistration values(" + uid + ",'" + TextBox1.Text + "','" + TextBox3.Text + "','" + TextBox8.Text + "','" + TextBox2.Text + "','" + DropDownList6.SelectedItem.ToString() + "','" + TextBox10.Text + "','" + dob + "','" + address + "','" + DropDownList10.SelectedItem.ToString() + "','" + TextBox11.Text + "',0,'" + document41 + "','" + TextBox4.Text + "','"+TextBox6.Text+"')";
                ob.exec(str);
